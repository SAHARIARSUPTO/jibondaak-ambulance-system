...
export default function AdminDashboardClient({ adminEmail }) {
              ...
              <div className="bg-white rounded-[2.5rem] p-8 border border-slate-100 shadow-sm">
                ...
                <div className="space-y-3">
                  {dashboardData?.users.map((user, index) => (
                    <div key={user.id || index} className="bg-slate-50 border border-slate-100 rounded-3xl p-5 flex items-center justify-between">
                      <div>
              ...
              <div className="bg-white rounded-[2.5rem] p-8 border border-slate-100 shadow-sm">
                ...
                <div className="space-y-3">
                  {dashboardData?.searchRequests.length === 0 ? (
                    ...
                    dashboardData?.searchRequests.map((req, index) => (
                      <div key={req.id || index} className="bg-slate-50 border border-slate-100 rounded-3xl p-5 shadow-sm">
