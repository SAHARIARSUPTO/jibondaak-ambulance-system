...
const HomePage = () => {
  ...
  return (
    <main className="bg-white text-slate-900 font-sans selection:bg-red-100">
      {/* 1. HERO SECTION */}
      <section className="relative min-h-[85vh] flex items-center justify-center border-b border-slate-100">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-12 text-center">
            ...
            <div className="space-y-4 p-6 hover:bg-slate-50 rounded-3xl transition-colors">
              ...
              <p className="text-slate-600 leading-relaxed">
                অ্যাম্বুলেন্সটি ম্যাপে ট্র্যাক করুন এবং কয়েক মিনিটের মধ্যেই সেটি
                আপনার দরজায় পৌঁছে যাবে।
              </p>
            </div>
          </div>
        </div>
