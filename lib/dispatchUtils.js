...
import { getRouteFare } from "@/lib/bookingStore";
...
export function resolveFare({ driverId, routeId, routeBaseFare, distance }) {
  const customFare = routeId ? getRouteFare(driverId, routeId) : undefined;
